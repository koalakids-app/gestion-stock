...
// Les directrices techniques rattachées à la crèche choisie.
...
// Retrouve, parmi les prénoms rapprochés, celui de la directrice technique titulaire.
...
async function spConfirmImport() {
  ...
  for (const j of _spData.jours) {
    ...
    for (const s of j.salaries) {
      ...
      // Si c'est la directrice technique titulaire, alimenter aussi son planning individuel.
